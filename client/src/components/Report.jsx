...
const Report = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setMessage('Thank you for reporting the issue. Our team will look into it shortly.');
      setIssue('');
    }, 2000);
  };
  ...
  return (
    <GlassCard>
      ...
      <Typography variant="body1" sx={{ 
        ...
        Found a bug or experiencing problems? Let us know what's wrong and we'll fix it as soon as possible.
      </Typography>
      ...
      {isMobile && (
        <Box sx={{ mt: 3, pt: 2, borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
          <Typography variant="body2" sx={{ 
            ...
            🔍 Please be specific about the issue to help us resolve it faster.
          </Typography>
        </Box>
      )}
    </GlassCard>
